        ...
        <>
            ...
            <div className="flex h-screen items-center justify-center">
                <main className="mx-auto min-h-[600px] w-full max-w-[450px]">
                    <Logo />
                    <h1 className="mb-1 mt-8 text-center text-xl font-bold tracking-[-0.16px] text-zinc-900 dark:text-zinc-200 sm:text-left">Log in to UniShops</h1>
                    <p className="mb-8 text-center text-base font-normal text-zinc-800 dark:text-zinc-300 sm:text-left">
                        {"Don't have an account?"}{" "}
                        <Link className="text-blue-600 dark:text-blue-500" href="/signup">
                            Sign up
                        </Link>
                    </p>
                    <LoginForm />
