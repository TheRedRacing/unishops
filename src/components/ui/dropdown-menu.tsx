...
const DropdownMenuItemVariant = cva("relative flex cursor-pointer select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none transition-colors data-[disabled]:pointer-events-none data-[disabled]:opacity-50", {
    variants: {
        variant: {
            default: "text-zinc-900 dark:text-zinc-50 focus:bg-zinc-100 focus:text-zinc-900 dark:focus:bg-zinc-800 dark:focus:text-zinc-50",
            destructive: "text-red-700 focus:bg-red-50 dark:text-red-400 dark:focus:bg-red-400/10",
        },
    },
    defaultVariants: {
        variant: "default",
