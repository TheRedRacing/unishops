...
export function LayoutHeader({ pro }: layoutHeaderProps) {
    return (
        <div className="fixed inset-x-0 top-0 z-50 flex h-14 items-center justify-between gap-12 px-4 backdrop-blur-md transition sm:px-6 lg:left-72 lg:z-30 lg:px-8 xl:left-80">
