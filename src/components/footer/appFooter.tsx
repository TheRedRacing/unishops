...
function SmallPrint() {
    return (
        <div className="flex flex-col items-center justify-between gap-5 border-t border-zinc-900/5 pt-6 dark:border-white/10 sm:flex-row">
            <p className="text-xs text-zinc-600 dark:text-zinc-400">&copy; Copyright {new Date().getFullYear()} UniShops. All rights reserved.</p>
...
export function AppFooter() {
    return (
        <footer className="mx-auto w-full max-w-2xl space-y-10 pb-6 lg:max-w-5xl">
            <SmallPrint />
        </footer>
    );
}
